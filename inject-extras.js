  ...
  function injectStickyCTA(){
    ...
    bar.innerHTML =
      ...
      '<div class="lp-sticky-bonus">' +
        ...
        'Turma <strong>06/07</strong> · ' + HORARIO + ' · <s style="opacity:0.6;margin-right:4px;font-weight:400">R$ 4.000</s> R$ ' + TICKET.toLocaleString('pt-BR') + '.' +
      '</div>' +
    ...
    + '<div data-lp-extras="authority-split" class="lp-auth-split">'
      ...
      + '<div class="lp-auth-card lp-auth-card--olhar">'
        + '<div class="lp-auth-card__head">'
          ...
          + '<div class="lp-auth-card__sub">Mídia &amp; Comunidade Tech · 15M+ leitores</div>'
        + '</div>'
        + '<div class="lp-auth-card__big">'
          + '<b>15M<i>+</i></b>'
